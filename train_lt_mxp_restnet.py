...
parser.add_argument('--n_epochs', type=int, default=30, help='nr epochs') #
...
def train_model(model, sampling, optimizer, train_criterion, val_criterion, do_mixup, train_loader, val_loader,
    ...
    for epoch in range(n_epochs):
        ...
        accuracy, tr_auc, tr_k, tr_mcc, tr_f1, tr_bacc, tr_auc_all, tr_f1_all = evaluate_multi_cls(tr_labels, tr_preds,
                                                                                                   tr_probs,
                                                                                                   print_conf=print_conf,
                                                                                                   class_names=class_names,
                                                                                                   text_file=text_file_train,
                                                                                                   loss=tr_loss)
        accuracy, vl_auc, vl_k, vl_mcc, vl_f1, vl_bacc, vl_auc_all, vl_f1_all = evaluate_multi_cls(vl_labels, vl_preds,
                                                                                                   vl_probs,
                                                                                                   print_conf=print_conf,
                                                                                                   class_names=class_names,
                                                                                                   text_file=text_file_val,
                                                                                                   loss=vl_loss,
                                                                                                   lr=get_lr(optimizer))
