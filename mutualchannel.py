...
trainset    = torchvision.datasets.ImageFolder(root='/home/user5/MC/NBI_dataset2/train/', transform=transform_train)
trainloader = torch.utils.data.DataLoader(trainset, batch_size=32, shuffle=True, num_workers=16, drop_last = True)

testset = torchvision.datasets.ImageFolder(root='/home/user5/MC/NBI_dataset2/test/', transform=transform_test)
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000):
        ...
        self.layer4 = self._make_layer(block, 2400, layers[3], stride=1)
...
def Mask(nb_batch, channels):
    ...
    bar = bar.reshape(nb_batch,800*channels,1,1)
